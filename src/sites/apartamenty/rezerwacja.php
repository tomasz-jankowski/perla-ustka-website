        ...
        <div class="site-navbar bg-light">
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                <h2 class="mb-0 site-logo"><a href="/">Apartamenty Perła</a></h2>
              </div>
              <div class="col-10">
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-xl-block">
                      <li><a href="http://willa.perla.ustka.pl">Willa Perła</a></li>
                      <li>
                      ...
                      <a>Oferta</a>
                        <ul class="dropdown arrow-top">
                          <li><a href="/apartamenty/2-osobowy">Apartament 2-os.</a></li>
                          <li><a href="/apartamenty/4-5-osobowy">Apartament 4-5-os.</a></li>
                          <li><a href="/apartamenty/4-5-osobowy-niski-parter">Apartament 4-5-os. (niski parter)</a></li>
                        </ul>
                      </li>
            ...
            <div class="row">
                  ...
                  <div class="row form-group">
                      <div class="col-md-12">
                        ...
                        <select name="apartment" id="apartment" name="apartment" class="form-control" required>
                          ...
                          <option value="4-5 osobowy (niski parter)" <?php if($_SESSION['apartment'] == "4-5 osobowy (niski parter)") echo 'selected'; ?>>Apartament 4-5-osobowy (niski parter)</option>
                        </select>
                      </div>
                    </div>
              ...
              <div class="col-lg-4">
                <div class="p-4 mb-3 bg-white">
                  ...
                  <p class="mb-4"><a href="https://www.google.com/maps/place/Apartamenty+Per%C5%82a/@54.586096,16.8542923,17z/data=!3m1!4b1!4m8!3m7!1s0x46fe3e84d2eed5cf:0x35a63a89365ca97a!5m2!4m1!1i2!8m2!3d54.586096!4d16.856481?hl=pl">ul. Perłowa 9, 76-270 Ustka</a></p>
                  <p class="mb-0 font-weight-bold">Phone</p>
                  <p class="mb-4"><a href="tel:+48513780807">+48 513 780 807</a></p>
                  <p class="mb-0 font-weight-bold">Adres mailowy</p>
                  <p class="mb-0"><a href="mailto:perla@pensjonat.ustka.pl">perla@pensjonat.ustka.pl</a></p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4">
              ...
              <hr class="hr-footer">
              <p><a class="footer-text" href="https://www.google.com/maps/place/Apartamenty+Per%C5%82a/@54.586096,16.8542923,17z/data=!3m1!4b1!4m8!3m7!1s0x46fe3e84d2eed5cf:0x35a63a89365ca97a!5m2!4m1!1i2!8m2!3d54.586096!4d16.856481?hl=pl">ul. Perłowa 9, 76-270 Ustka</a></p>
              <p><a class="footer-text" href="tel:+48513780807"><span class="icon-phone2 small"></span> +48 513 780 807</a></p>
              <p><a class="footer-text" href="mailto:perla@pensjonat.ustka.pl">perla@pensjonat.ustka.pl</a></p>
            </div>
            <div class="col-md-4">
            ...
            <hr class="hr-footer">
            <ul class="list-unstyled">
              <li><a href="http://willa.perla.ustka.pl" class="footer-text"><span class="icon-keyboard_arrow_right small"></span> Willa Perła</a></li>
